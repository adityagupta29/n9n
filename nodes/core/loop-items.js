 ...
 * n9n Node: Loop Items
 * Category: logic
 * Description: Loop through array items one by one
 * Author: n9n
 * Version: 1.0.0
 */
...
n9n.registerNode({
  ...
  suggests: ['draft-email', 'open-url'],
  
  documentation: {
    description: 'Loops through an array of items and processes each one individually.',
    input: 'Array of strings or values',
    output: 'Passes each item to the next node one at a time',
    example: 'Input: ["Apple", "Banana"] → 1st run: "Apple", 2nd run: "Banana"'
  },
